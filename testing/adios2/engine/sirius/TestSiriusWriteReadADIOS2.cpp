...
TEST_F(SiriusWriteReadTestADIOS2, ADIOS2SiriusWriteRead2D)
{
...
#endif
    {
        ...
        io.SetEngine("Sirius");
        io.SetParameter("storage tiers", "3");
        io.SetParameter("wavelet name", "haar");
        io.SetParameter("wavelet levels", "3");
        io.AddTransport("File", {{"level id", "0"}, {"location", "/Users/lwk/Research/Projects/adios2/dev/pfs"}, {"percentage","0.0"}, {"persistent","true"}});  // only metadata will be saved on level 0 which must be persistent storage
        io.AddTransport("File", {{"level id", "1"}, {"location", "/Users/lwk/Research/Projects/adios2/dev/bb"}, {"percentage","0.2"}, {"persistent","false"}});
        io.AddTransport("File", {{"level id", "2"}, {"location", "/Users/lwk/Research/Projects/adios2/dev/pfs"}, {"percentage","0.3"}, {"persistent","true"}});
        io.AddTransport("File", {{"level id", "3"}, {"location", "/Users/lwk/Research/Projects/adios2/dev/tape"}, {"percentage","0.5"}, {"persistent","true"}});
