...
#ifndef ADIOS2_ENGINE_SIRIUSREADER_H_
#define ADIOS2_ENGINE_SIRIUSREADER_H_
...
class SiriusReader : public Engine
{
public:
    /**
     ...
     * @param hostLanguage
     */
    SiriusReader(IO &adios, const std::string &name, const Mode mode,
                   helper::Comm comm);
...
private:
    ...
    void Init() final; ///< called from constructor, gets the selected Sirius
...
#endif /* ADIOS2_ENGINE_SIRIUSREADER_H_ */